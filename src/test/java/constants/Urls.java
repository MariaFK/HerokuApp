...
public class Urls {
    ...
    public static final String DATA_TABLE_URL = "http://the-internet.herokuapp.com/tables";
    ...
    public static final String NOTIFICATION_MASSAGES_URL = "http://the-internet.herokuapp.com/notification_message_rendered";

    public static final String ALERTS_URL = "http://the-internet.herokuapp.com/javascript_alerts";

    public static final String DRAG_AND_DROP_URL = "https://jqueryui.com/droppable/";
